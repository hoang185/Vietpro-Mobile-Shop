...
$id_per_page =3;
$id_start = $id_per_page*$page-$id_per_page;
$page_prev=$page-1;
$total_page=ceil(mysqli_num_rows(mysqli_query($conn,'SELECT * FROM category'))/$id_per_page);
if($page_prev<1){
	$page_prev=1;
}
$list_page='';
					...
					<div class="panel panel-default">
							<div class="panel-body">
								<table 
									...
									<tbody>
									<?php
									$sql="SELECT * FROM category ORDER BY cat_id DESC LIMIT $id_start,$id_per_page";
									...
									?>
										<tr>
											...
											<td class="form-group">
												...
												<a onclick="return del('<?php echo $row['cat_name']; ?>')" href="del_category.php?cat_id=<?= $row['cat_id'] ?>" class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i></a>
											</td>
										</tr>
										<?php } ?>
										<!-- <tr>
