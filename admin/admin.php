<?php
if(!defined("SECURITY")){
	die("ban ko co quyen truy cap trang nay admin");
}
?>
					...
					<div class="navbar-header">
						...
						<ul class="user-menu">
							<li class="dropdown pull-right">
								<a href="index.php" class="dropdown-toggle" data-toggle="dropdown"><svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg><?="Xin chao ".$_SESSION["mail"]?><span class="caret"></span></a>
