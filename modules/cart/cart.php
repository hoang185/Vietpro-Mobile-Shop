                ...
                <div id="my-cart">
                    ...
                    <div class="cart-item row">
                        ...
                        <div class="cart-quantity col-lg-2 col-md-2 col-sm-12">
                        	<input name="qtt[<?= $row['prd_id']?>]" type="number" 
                            id="quantity" class="form-control form-blue quantity" value="<?= $_SESSION['cart'][$row['prd_id']] ?>" min="1">
                        </div> 
                        <div class="cart-price col-lg-3 col-md-3 col-sm-12"><b><?= number_format($total_price) ?>đ</b>
                           <a href="modules/cart/cart_del.php?prd_id=<?= $row['prd_id'] ?>">Xóa</a>
                        </div>    
                    </div>  
                   <?php } ?>
